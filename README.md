# Next.JS Table Filter
A Next.Js Filter Table using ShadCN UI.
...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,nodejs,tailwind,vscode,linux)](https://skillicons.dev)

## 🛠 Skills

[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,nextjs,git,github)](https://skillicons.dev)
